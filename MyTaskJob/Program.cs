...
namespace MyTaskJob
{
    class Program
    {
        static void Main(string[] args)
        {
           ...
           // LngIDailyTrigger trigger = (IDailyTrigger)task.Triggers.Create(_TASK_TRIGGER_TYPE2.TASK_TRIGGER_TIME);
           ...
           // IRunningTask runTask = regTask.Run(null);
            ...
            decimal Lng = Convert.ToDecimal(108.887262);

            decimal Lat = Convert.ToDecimal(34.230277);
